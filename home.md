...
python and large, complex datasets. This is primarily through problems I've solved using LeetCode and StrataScratch; although I've also developed a codebase for processing stock [market data](https://github.com/jdejones/market_data) and a [news tracker](https://github.com/jdejones/News_Tracker). To avoid a wall of text, LeetCode problem links are now on a separate page: **[LeetCode solutions](leetcode/)**. As the purpose of these solutions is to exercise problem solving I don't use A.I. to solve the leetcode and stratascratch problems. My codebase is mostly my code combined with some code prompted. 
...
- [Intraday Clusters](https://nbviewer.org/github/jdejones/market_data/blob/main/intraday_clusters.ipynb)

# Recent commits
<!-- RECENT_COMMITS_START -->
_Last updated: 2026-02-10 07:53 CST_
...
- [**jdejones/news_tracker**](github.com/jdejones/jdejones/news_tracker): [Corrected database url.](https://github.com/jdejones/news_tracker/commit/a1b376a575d32c6aec339ce22fc076325769e6a3) — 2026-02-08 17:13 CST
- [**jdejones/Healthcare_Data**](github.com/jdejones/jdejones/Healthcare_Data): [Edited loop start.](https://github.com/jdejones/Healthcare_Data/commit/d9e866655e251825303f5e3ac9791797cdc96da9) — 2026-02-07 17:14 CST
<!-- RECENT_COMMITS_END -->
{% comment %}
